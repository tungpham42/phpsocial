...
function menu($user) {
	...
	if($user !== false) {
		...
		$TMPL['avatar'] = ($CONF['url'].'/thumb.php?t=a&w=50&h=50&src='.$user['image']);
							...
							<div class="message-inner">
								...
								<div class="message-avatar" id="avatar'.$row['id'].'">
									<a href="'.permalink($this->url.'/index.php?a=profile&u='.$row['username']).'" rel="loadpage">
										<img src="'.$this->url.'/thumb.php?t=a&w=50&h=50&src='.$row['image'].'">
									</a>
								</div>
								<div class="message-top">
...
class feed {
	...
	function getMessages($query, $type, $typeVal) {
		...
		foreach($rows as $row) {
			...
			$profile_img = (isset($this->page_data['by']) && $row['idu'] == $this->page_data['by'] ? $this->url.'/thumb.php?t=a&w=50&h=50&src='.$this->page_data['image'] : $this->url.'/thumb.php?t=a&w=50&h=50&src='.$row['image']);
				...
				<div class="message-content">
					...
					<div class="message-comment-box-container" id="comment_box_'.$row['id'].'"'.$style.'>
						<div class="message-reply-avatar">
							'.((!empty($this->user)) ? '<img src="'.$this->url.'/thumb.php?t=a&w=50&h=50&src='.(isset($this->page_data['by']) && $this->id == $this->page_data['by'] ? $this->page_data['image'] : $this->user['image']).'">' : '').'
						</div>
		...
		$cover = '<div class="twelve columns">
					<div class="cover-container">
						<div class="cover-content">
							<a onclick="gallery(\''.$group['cover'].'\', \''.($group['id'] ?? null).($group['title'] ?? null).'\', \'covers\', 0)" id="'.$group['cover'].'"><div class="cover-image" style="background-position: center; background-image: url('.$this->url.'/thumb.php?t=c&w=900&h=200&src='.$group['cover'].')">
							</div></a>
	...
	function fetchPage($page) {
		...
		$cover = '<div class="twelve columns">
					<div class="cover-container">
						<div class="cover-content">
							<a onclick="gallery(\''.$page['cover'].'\', \''.$page['id'].$page['name'].'\', \'covers\', 0)" id="'.$page['cover'].'"><div class="cover-image" style="background-position: center; background-image: url('.$this->url.'/thumb.php?t=c&w=900&h=200&src='.$page['cover'].')">
							</div></a>
							<div class="cover-description">
								<div class="cover-avatar-content">
									<div class="cover-avatar">
										<a onclick="gallery(\''.$page['image'].'\', \''.$page['id'].$page['name'].'\', \'avatars\', 0)" id="'.$page['image'].'"><span id="avatar'.$page['id'].$page['name'].'"><img src="'.$this->url.'/thumb.php?t=a&w=150&h=150&src='.$page['image'].'"></span></a>
									</div>
								</div>
	...
	function fetchProfile($profile) {
		...
		$cover = '<div class="twelve columns">
					<div class="cover-container">
						<div class="cover-content">
							<a onclick="gallery(\''.$profile['cover'].'\', \''.$profile['idu'].$profile['username'].'\', \'covers\', 0)" id="'.$profile['cover'].'"><div class="cover-image" style="background-position: center; background-image: url('.$this->url.'/thumb.php?t=c&w=900&h=200&src='.$profile['cover'].'">
							</div></a>
							<div class="cover-description">
								<div class="cover-avatar-content">
									<div class="cover-avatar">
										<a onclick="gallery(\''.$profile['image'].'\', \''.$profile['idu'].$profile['username'].'\', \'avatars\', 0)" id="'.$profile['image'].'"><span id="avatar'.$profile['idu'].$profile['username'].'"><img src="'.$this->url.'/thumb.php?t=a&w=150&h=150&src='.$profile['image'].'"></span></a>
									</div>
								</div>
	...
	function profileCard($data, $type) {
		...
		$card = '
			<div class="profile-card-cover">
				<img src="'.$this->url.'/thumb.php?t=c&w=300&h=100&src='.$data['cover'].'">
			...
			<div class="profile-card-avatar">
				<a href="'.$url.'"><img src="'.$this->url.'/thumb.php?t=a&w=112&h=112&src='.$data['image'].'"></a>
			</div>
		...
		$widget =  '<div class="sidebar-container widget-welcome">
						<div class="sidebar-content">
							...
							<div class="sidebar-inner">
								<div class="sidebar-avatar"><a href="'.permalink($this->url.'/index.php?a=profile&u='.$username).'" rel="loadpage"><img src="'.$this->url.'/thumb.php?t=a&w=50&h=50&src='.$image.'"></a></div>
			...
			foreach($array as $value) {
				...
				if($value['event'] == 'like') {
					...
					if($for == 2 || !$for) {
						...
						$events .= '<div class="'.$notification_image.'"><a href="'.permalink($this->url.'/index.php?a=profile&u='.$value['username']).'" rel="loadpage"><img class="notifications" src="'.($this->url.'/thumb.php?t=a&w=50&h=50&src='.$value['image']).'"></a></div><div class="notification-text notification-friendships"><a href="'.permalink($this->url.'/index.php?a=profile&u='.$value['username']).'" rel="loadpage">'.realName($value['username'], $value['first_name'], $value['last_name']).'</a><br><span class="timeago'.$b.'" title="'.$time.'">'.$time.'</span></div><div class="notification-buttons" id="notification-buttons'.$value['id'].'"><div class="notification-button button-normal"><a onclick="friend(\''.$value['idu'].'\', \'3\', \''.$value['id'].'\')">'.$LNG['decline'].'</a></div><div class="notification-button button-active"><a onclick="friend(\''.$value['idu'].'\', \'2\', \''.$value['id'].'\')">'.$LNG['confirm'].'</a></div></div>';
					}
		...
		if($result = $this->db->query($query)) {
			...
			foreach($rows as $comment) {
				...
				if($comment['type'] == 'picture') {
					$commentMedia = '<div class="comment-image-thumbnail"><a onclick="gallery(\''.$comment['value'].'\', '.$comment['id'].', \'media\', 2)" id="'.$comment['value'].'"><img src="'.($this->url.'/thumb.php?t=m&w=200&h=200&src='.$comment['value']).'"></a></div>';
				}
				...
				<div class="message-reply-container" id="comment'.$comment['id'].'">
					...
					<div class="message-reply-avatar" id="avatar-c-'.$comment['id'].'">
						<a href="'.permalink($this->url.'/index.php?a=profile&u='.$comment['username']).'" rel="loadpage"><img onmouseover="profileCard('.$comment['idu'].', '.$comment['id'].', 1, 0, 0)" onmouseout="profileCard(0, 0, 1, 1, 0);" onclick="profileCard(0, 0, 1, 1, 0);" src="'.($this->url.'/thumb.php?t=a&w=50&h=50&src='.$comment['image']).'"></a>
					</div>
	...
	function getChatType($type, $value, $id) {
		...
		switch($type) {
			case "picture":
			return '<div class="chat-image-thumbnail"><a onclick="gallery(\''.$value.'\', '.$id.', \'media\', 3)" id="'.$value.'"><img src="'.($this->url.'/thumb.php?t=m&w=100&h=100&src='.$value).'"></a></div>';
		}
	}
	...
	function getMessageType($type, $value, $id) {
		...
		switch($type) {
			...
			case "picture":
				...
				$result = '';
				if(count($images) == 1) {
					$result .= '<div class="message-type-image event-picture"><a onclick="gallery(\''.$images[0].'\', '.$id.', \'media\', 1)" id="'.$images[0].'"><img src="'.($this->url.'/thumb.php?t=m&w=650&h=300&src='.$images[0]).'"></a>';
				} elseif(count($images) == 2) {
					$result .= '<div class="message-type-image event-picture"><div class="image-container-padding">';
					foreach($images as $image) {
						$result .= '<a onclick="gallery(\''.$image.'\', '.$id.', \'media\', 1)" id="'.$image.'"><div class="image-thumbnail-container-half"><div class="image-thumbnail"><img src="'.($this->url.'/thumb.php?t=m&w=300&h=300&src='.$image).'"></div></div></a>';
					}
					$result .= '</div>';
				} elseif(count($images) == 3) {
					$result .= '<div class="message-type-image event-picture"><div class="image-container-padding">';
					foreach($images as $image) {
						$result .= '<a onclick="gallery(\''.$image.'\', '.$id.', \'media\', 1)" id="'.$image.'"><div class="image-thumbnail-container"><div class="image-thumbnail"><img src="'.($this->url.'/thumb.php?t=m&w=200&h=200&src='.$image).'"></div></div></a>';
					}
					$result .= '</div>';
					...
					foreach($images as $image) {
						if($i == 1) {
							$result .= '<a onclick="gallery(\''.$image.'\', '.$id.', \'media\', 1)" id="'.$image.'"><div class="fake"><div class="image-thumbnail"><img src="'.($this->url.'/thumb.php?t=m&w=650&h=300&src='.$image).'"></div></div></a>';
						} else {
							// If there are more than 4 images, hide them
							if($i > 4) {
								$result .= '<a onclick="gallery(\''.$image.'\', '.$id.', \'media\', 1)" id="'.$image.'" style="display: none;"></a>';
							} else {
								$result .= '<a onclick="gallery(\''.$image.'\', '.$id.', \'media\', 1)" id="'.$image.'"><div class="image-thumbnail-container"><div class="image-thumbnail">'.($i == 4 && count($images) > 4 ? '<span class="image-thumbnail-text">+ '.(count($images)-4).'</span>' : '').'<img src="'.($this->url.'/thumb.php?t=m&w=200&h=200&src='.$image).'"></div></div></a>';
							}
						}
						$i++;
					}
		...
		if(!empty($rows)) {
			if($for == 0) {
				...
				foreach($rows as $row) {
					...
					$output .= '<a href="'.permalink($this->url.'/index.php?a=profile&u='.$row['username']).'" rel="loadpage"><div class="sidebar-subscriptions"><div class="sidebar-title-container"><div class="sidebar-title-name">'.$username.'</div></div><img src="'.($this->url.'/thumb.php?t=a&w=112&h=112&src='.$row['image']).'"></div></a>';
					$i++;
				}
				$output .= '</div></div></div>';
			} elseif($for == 1) {
		...
		if($type == 1) {
			...
			if(!empty($rows)) {
				...
				foreach($rows as $row) {
					...
					$url = ($window) ? '<a onclick="openChatWindow(\''.$row['idu'].'\', \''.$row['username'].'\', \''.addslashes(realName($row['username'], $row['first_name'], $row['last_name'])).'\', \''.$this->url.'\', \''.$this->url.'/'.$CONF['theme_url'].'/images/icons/'.$icon.'.png\')"><img src="'.$this->url.'/'.$CONF['theme_url'].'/images/icons/'.$icon.'.png" class="sidebar-status-icon"> <img src="'.($this->url.'/thumb.php?t=a&w=25&h=25&src='.$row['image']).'"> '.realName($row['username'], $row['first_name'], $row['last_name']).'</a>' : '<a href="'.permalink($this->url.'/index.php?a=messages&u='.$row['username'].'&id='.$row['idu']).'" rel="loadpage"><img src="'.$this->url.'/'.$CONF['theme_url'].'/images/icons/'.$icon.'.png" class="sidebar-status-icon"> <img src="'.($this->url.'/thumb.php?t=a&w=25&h=25&src='.$row['image']).'"> '.realName($row['username'], $row['first_name'], $row['last_name']).'</a>';
			...
			if(!empty($rows)) {
				...
				foreach($rows as $row) {
					...
					<div class="message-reply-container '.$class.'" data-chat-id="'.$row['id'].'" >
						'.$delete.'
						<div class="message-reply-avatar">
							<a href="'.permalink($this->url.'/index.php?a=profile&u='.$row['username']).'" rel="loadpage" title="'.realName($row['username'], $row['first_name'], $row['last_name']).'" id="avatar-m-'.$row['id'].'"><img src="'.($this->url.'/thumb.php?t=a&w=50&h=50&src='.$row['image']).'"></a>
						</div>
	...
	function sidebarPages($visible = null) {
		...
		if($row) {
			...
			foreach($row as $page) {
				...
				$output .= '<div class="sidebar-link sidebar-page" id="page-'.$page['id'].'"'.$hidden.'><a href="'.permalink($this->url.'/index.php?a=page&name='.$page['name']).'" rel="loadpage"><img src="'.($this->url.'/thumb.php?t=a&w=48&h=48&src='.$page['image']).'" width="24" height="24">'.($notifications ? '<span class="admin-notifications-number sidebar-notifications-number">'.$notifications.'</span>' : '').''.$page['title'].'</a><div class="sidebar-settings-container" onclick="messageMenu('.$page['id'].', 3)"><div class="settings_btn sidebar-settings'.($visible ? '' : ' s-settings-hidden').'"></div></div></div>';
	...
	function getMentions($target, $string) {
		...
		if($query->num_rows > 0) {
			...
			while($row = $query->fetch_assoc()) {
				$output .= '<div class="mention-user" onclick="doMention(\''.htmlspecialchars($target, ENT_QUOTES, 'UTF-8').'\', \''.htmlspecialchars($string, ENT_QUOTES, 'UTF-8').'\', \''.$row['username'].'\')"><img src="'.($this->url.'/thumb.php?t=a&w=25&h=25&src='.$row['image']).'" width="16" height="16"> <strong>@'.$row['username'].'</strong> '.realName(null, $row['first_name'], $row['last_name']).'</div>';
			}
			$output .= '</div>';
		} else {
			return false;
	...
	function sidebarFriendsActivity($limit, $type = null) {
		...
		foreach($array as $value) {
			...
			if($value['event'] == 'like') {
				$activity .= '<div class="sidebar-fa-image"><a href="'.permalink($this->url.'/index.php?a=profile&u='.$value['username']).'" rel="loadpage"><img class="notifications" src="'.($this->url.'/thumb.php?t=a&w=50&h=50&src='.$value['image']).'"></a></div><div class="sidebar-fa-text">'.sprintf($LNG['new_like_fa'], permalink($this->url.'/index.php?a=profile&u='.$value['username']), realName($value['username'], $value['first_name'], $value['last_name']), permalink($this->url.'/index.php?a=post&m='.$value['post'])).'. <span class="timeago'.$b.'" title="'.$time.'">'.$time.'</span></div>';
			} elseif($value['event'] == 'comment') {
				$activity .= '<div class="sidebar-fa-image"><a href="'.permalink($this->url.'/index.php?a=profile&u='.$value['username']).'" rel="loadpage"><img class="notifications" src="'.($this->url.'/thumb.php?t=a&w=50&h=50&src='.$value['image']).'"></a></div><div class="sidebar-fa-text">'.sprintf($LNG['new_comment_fa'], permalink($this->url.'/index.php?a=profile&u='.$value['username']), realName($value['username'], $value['first_name'], $value['last_name']), permalink($this->url.'/index.php?a=post&m='.$value['mid'])).'. <span class="timeago'.$b.'" title="'.$time.'">'.$time.'</span></div>';
			}
			$activity .= '</div></div>';
			$i++;
		}
	...
	function sidebarSuggestions($interests) {
		...
		if(!empty($rows)) {
			...
			foreach($rows as $row) {
				...
				// Add the elemnts to the array
				$output .= '<a href="'.permalink($this->url.'/index.php?a=profile&u='.$row['username']).'" rel="loadpage"><div class="sidebar-subscriptions"><div class="sidebar-title-container"><div class="sidebar-title-name">'.realName($row['username'], $row['first_name'], $row['last_name']).'</div></div><img src="'.($this->url.'/thumb.php?t=a&w=112&h=112&src='.$row['image']).'"></div></a>';
				$i++;
			}
			$output .= '</div></div></div>';
			return $output;
	...
	function getLikes($start = null, $type = null, $value = null, $for = null) {
		...
		if($type == 1) {
			...
			if($start) {
				...
				while($row = $query->fetch_assoc()) {
					$rows .= '<div class="likes-users"><a href="'.permalink($this->url.'/index.php?a=profile&u='.$row['username']).'" title="'.realName($row['username'], $row['first_name'], $row['last_name']).'" rel="loadpage"><img src="'.($this->url.'/thumb.php?t=a&w=112&h=112&src='.$row['image']).'"></a></div>';
				}
				$rows .= '</div>';
				return $rows;
			} else {
					...
					$output .= '<div class="message-inner" id="group'.$row['id'].'">
									...
									<div class="message-avatar">
										<a href="'.permalink($this->url.'/index.php?a=group&name='.$row['name']).'" rel="loadpage">
											<img src="'.($this->url.'/thumb.php?t=c&w=48&h=48&src='.$row['cover']).'">
										</a>
									</div>
									<div class="message-top">
										<div class="message-author">
				...
				$output .= '<div class="'.$class.'" id="group'.$row['id'].'">
								<div class="message-content">
									<div class="message-inner">
										...
										<div class="message-avatar">
											<a href="'.permalink($this->url.'/index.php?a=group&name='.$row['name']).'" rel="loadpage">
												<img src="'.(isset($admin) ? $this->url.'/thumb.php?t=c&w=48&h=48&src='.$row['cover'] : ($this->url.'/thumb.php?t=c&w=48&h=48&src='.$row['cover'])).'">
											</a>
										</div>
										<div class="message-top">
											<div class="message-author">
					...
					$output .= '<div class="message-inner" id="page'.$row['id'].'">
									...
									<div class="message-avatar">
										<a href="'.permalink($this->url.'/index.php?a=page&name='.$row['name']).'" rel="loadpage">
											<img src="'.($this->url.'/thumb.php?t=a&w=48&h=48&src='.$row['image']).'">
										</a>
									</div>
									<div class="message-top">
										<div class="message-author">
				...
				$output .= '<div class="'.$class.'" id="page'.$row['id'].'">
								<div class="message-content">
									<div class="message-inner">
										...
										<div class="message-avatar">
											<a href="'.permalink($this->url.'/index.php?a=page&name='.$row['name']).'" rel="loadpage">
												<img src="'.(isset($admin) ? $this->url.'/thumb.php?t=a&w=48&h=48&src='.$row['image'] : ($this->url.'/thumb.php?t=a&w=48&h=48&src='.$row['image'])).'">
											</a>
										</div>
										<div class="message-top">
											<div class="message-author">
...
function showUsers($users, $url) {
	...
	foreach($users as $user) {
		$x .= '<div class="welcome-user"><a href="'.permalink($url.'/index.php?a=profile&u='.$user['username']).'" rel="loadpage"><img src="'.($url.'/thumb.php?t=a&w=112&h=112&src='.$user['image']).'"></a></div>';
	}
	return $x;
}
